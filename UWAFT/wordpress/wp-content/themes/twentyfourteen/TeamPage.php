  ...
  <p></p>
    <div class="container marketing">
      <div class="row">
        ...
        <div class="col-lg-4">
          <img src="images/team_profile3.jpg" alt="Generic placeholder image" style="width: 140px; height: 140px;">
        ...
        <div class="col-lg-4">
          <img src="images/team_profile6.jpg" alt="Generic placeholder image" style="width: 140px; height: 140px;">
          <h2>Project Manager</h2>
          <p>Donec sed odio dui. Cras justo odio, dapibus ac facilisis in, egestas eget quam. Vestibulum id ligula porta felis euismod semper. Fusce dapibus, tellus ac cursus commodo, tortor mauris condimentum nibh, ut fermentum massa justo sit amet risus.</p>
        </div><!-- /.col-lg-4 -->
      </div><!-- /.row -->
        ...
        <div class="col-lg-4">
          <img src="images/team_profile9.jpg" alt="Generic placeholder image" style="width: 140px; height: 140px;">
          <h2>Project Manager</h2>
          <p>Donec sed odio dui. Cras justo odio, dapibus ac facilisis in, egestas eget quam. Vestibulum id ligula porta felis euismod semper. Fusce dapibus, tellus ac cursus commodo, tortor mauris condimentum nibh, ut fermentum massa justo sit amet risus.</p>
        </div><!-- /.col-lg-4 -->
      </div><!-- /.row -->
